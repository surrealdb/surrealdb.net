...
internal class SurrealDbResultConverter : JsonConverter<ISurrealDbResult>
{
	...
	public override ISurrealDbResult? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
	{
	...
	public override void Write(Utf8JsonWriter writer, ISurrealDbResult value, JsonSerializerOptions options)
	{
