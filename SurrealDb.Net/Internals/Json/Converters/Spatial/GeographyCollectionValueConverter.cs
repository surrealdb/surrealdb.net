...
{
    public override GeographyCollection? Read(
    ...
    )
    {
        ...
        if (root.TryGetProperty(SpatialConverterConstants.TypePropertyName, out var typeProperty))
        {
            ...
            if (type == CollectionConverter.TypeValue)
            {
                ...
                if (geometriesProperty.ValueKind != JsonValueKind.Array)
                    throw new JsonException(
                        $"Cannot deserialize {nameof(GeographyCollection)} because coordinates must be an array"
                    );
                ...
                foreach (var geometryProperty in geometriesProperty.EnumerateArray())
                {
                    ...
                    switch (geometryType)
                    {
                        case PointConverter.TypeValue:
                            PointConverter.ConstructGeographyPoint(
                        ...
                        case LineStringConverter.TypeValue:
                            ...
                            LineStringConverter.ConstructGeographyLineString(
                                ref coordinatesProperty,
                                geographyBuilder
                            );
                            break;
                        case PolygonConverter.TypeValue:
                            ...
                            PolygonConverter.ConstructGeographyPolygon(
                                ref coordinatesProperty,
                                geographyBuilder
                            );
                            break;
                        case MultiPointConverter.TypeValue:
                            ...
                            MultiPointConverter.ConstructGeographyMultiPoint(
                                ref coordinatesProperty,
                                geographyBuilder
                            );
                            break;
                        ...
                        default:
                            throw new JsonException(
                                $"Cannot deserialize {nameof(GeographyCollection)}. Unknown geometry type \"{geometryType}\""
                            );
                    }
                }
            ...
            throw new JsonException(
                $"Cannot deserialize {nameof(GeographyCollection)} because of type \"{type}\""
            );
        }
    ...
    )
    {
        ...
        foreach (var geography in value.Geographies)
        {
            switch (geography)
            {
                ...
                default:
                    throw new JsonException(
                        $"Cannot serialize {nameof(GeographyCollection)}. Unknown geometry type \"{geography.GetType().Name}\""
                    );
            }
        }
