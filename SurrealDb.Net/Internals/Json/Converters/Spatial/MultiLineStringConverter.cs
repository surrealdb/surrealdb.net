...
internal class MultiLineStringConverter
{
	...
	public static void WriteGeometryMultiLineString(Utf8JsonWriter writer, GeometryMultiLineString value)
	{
		if (value is null)
		{
	...
	public static void WriteGeographyMultiLineString(Utf8JsonWriter writer, GeographyMultiLineString value)
	{
		if (value is null)
		{
			writer.WriteNullValue();
