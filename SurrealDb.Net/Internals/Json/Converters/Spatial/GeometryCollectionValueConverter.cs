...
{
    public override GeometryCollection? Read(
    ...
    )
    {
        ...
        if (root.TryGetProperty(SpatialConverterConstants.TypePropertyName, out var typeProperty))
        {
            ...
            {
                var geometriesProperty = root.GetProperty(
                    SpatialConverterConstants.GeometriesPropertyName
                );

                if (geometriesProperty.ValueKind != JsonValueKind.Array)
                    throw new JsonException(
                        $"Cannot deserialize {nameof(GeometryCollection)} because coordinates must be an array"
                    );
                ...
                {
                    var geometryType = geometryProperty
                        .GetProperty(SpatialConverterConstants.TypePropertyName)
                        .GetString();
                    var coordinatesProperty = geometryProperty.GetProperty(
                    ...
                    switch (geometryType)
                    {
                        case PointConverter.TypeValue:
                            PointConverter.ConstructGeometryPoint(
                        ...
                        case LineStringConverter.TypeValue:
                            ...
                            LineStringConverter.ConstructGeometryLineString(
                                ref coordinatesProperty,
                                geometryBuilder
                            );
                            break;
                        case PolygonConverter.TypeValue:
                            ...
                            PolygonConverter.ConstructGeometryPolygon(
                                ref coordinatesProperty,
                                geometryBuilder
                            );
                            break;
                        case MultiPointConverter.TypeValue:
                            ...
                            MultiPointConverter.ConstructGeometryMultiPoint(
                                ref coordinatesProperty,
                                geometryBuilder
                            );
                            break;
                        case MultiLineStringConverter.TypeValue:
                            ...
                            MultiLineStringConverter.ConstructGeometryMultiLineString(
                                ref coordinatesProperty,
                                geometryBuilder
                            );
                            break;
                        case MultiPolygonConverter.TypeValue:
                            ...
                            MultiPolygonConverter.ConstructGeometryMultiPolygon(
                                ref coordinatesProperty,
                                geometryBuilder
                            );
                            break;
                        default:
                            throw new JsonException(
                                $"Cannot deserialize {nameof(GeometryCollection)}. Unknown geometry type \"{geometryType}\""
                            );
                    }
                }
            ...
            throw new JsonException(
                $"Cannot deserialize {nameof(GeometryCollection)} because of type \"{type}\""
            );
        }
