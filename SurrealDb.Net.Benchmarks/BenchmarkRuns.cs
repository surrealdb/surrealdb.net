...
public static class BenchmarkRuns
{
    ...
    public static async Task<List<ProductAlsoPurchased>> Scenario(ISurrealDbClient surrealDbClient)
    {
        ...
        // Create records
        var pratimHomeId = new RecordId("address", "pratim_home");
        var tobieHomeId = new RecordId("address", "tobie_home");
        var alexHomeId = new RecordId("address", "alex_home");
        ...
        var customers = new List<Customer>
        {
            new Customer
            {
                Id = new RecordId("customer", "pratim"),
                Name = "pratim",
                Email = "abc@gmail.com",
            ...
            new Customer
            {
                Id = new RecordId("customer", "tobie"),
                Name = "Tobie",
        ...
        var products = new List<Product>
        {
            ...
            new Product
            {
                Id = new RecordId("product", "trousers"),
                Name = "Trousers",
                Description = "Pants",
                Price = 10,
                Category = "clothing",
            ...
            new Product
            {
                Id = new RecordId("product", "iphone"),
                Name = "Iphone",
