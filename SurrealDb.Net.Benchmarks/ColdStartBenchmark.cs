...
public class ColdStartBenchmark : BaseBenchmark
{
	...
	{
		var client = new SurrealDbClient(HttpUrl, _serviceProvider!.GetRequiredService<IHttpClientFactory>());
		_clients.Add(client);
	...
	{
		var client = SurrealDbHttpClient.New(Host, _serviceProvider!.GetRequiredService<IHttpClientFactory>());
		_clients.Add(client);
