...
public class OrderingQueryableTests : BaseQueryableTests
{
    ...
    public void ShouldOrderByAsc()
    {
        ...
        query
            ...
            .Be(
                """
                SELECT content, created_at, id, status, title FROM post ORDER BY created_at
                """
            );
    }
    ...
    public void ShouldOrderByDesc()
    {
        ...
        query
            ...
            .Be(
                """
                SELECT content, created_at, id, status, title FROM post ORDER BY created_at DESC
                """
            );
    }
    ...
    public void ShouldOrderByMultipleFieldsAsc()
    {
        ...
        query
            ...
            .Be(
                """
                SELECT content, created_at, id, status, title FROM post ORDER BY created_at, status, title
                """
            );
    }
    ...
    public void ShouldOrderByMultipleFieldsEitherAscOrDesc()
    {
        ...
        query
            ...
            .Be(
                """
                SELECT content, created_at, id, status, title FROM post ORDER BY created_at DESC, status DESC, title
                """
            );
    }
    ...
    public void ShouldSkipPreviousOrderExpressions()
    {
        ...
        query
            ...
            .Be(
                """
                SELECT content, created_at, id, status, title FROM post ORDER BY status DESC
                """
            );
    }
}
