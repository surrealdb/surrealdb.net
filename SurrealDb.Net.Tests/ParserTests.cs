...
public class ParserTests
{
    ...
    public async Task ShouldParseRecordId(string connectionString)
    {
...

        {
            ...
            autoGeneratedRecord!.Id!.Table.ToString().Should().Be("recordId");
...

        {
            ...
            stringRecord!.Id!.Table.ToString().Should().Be("recordId");
...

        {
            ...
            numberRecord!.Id!.Table.ToString().Should().Be("recordId");
...

        {
            ...
            complexRecord!.Id!.Table.ToString().Should().Be("recordId");
...

        {
            ...
            complex2Record!.Id!.Table.ToString().Should().Be("recordId");
