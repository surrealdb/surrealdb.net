...
public class ParserTests
{
    ...
    public async Task ShouldParseRecordId(string connectionString)
    {
        ...
        var records = await client.Select<RecordIdRecord>("recordId").ToListAsync();
    ...
    public async Task ShouldParseDurationAsString(string connectionString)
    {
        ...
        var records = await client.Select<StringRecord>("duration").ToListAsync();
    ...
    public async Task ShouldParseTimeOnly(string connectionString)
    {
        ...
        var records = await client.Select<TimeOnlyRecord>("duration").ToListAsync();
    ...
    public async Task ShouldParseDateOnly(string connectionString)
    {
        ...
        var records = await client.Select<DateOnlyRecord>("datetime").ToListAsync();
