...
public class TypesTests
{
    ...
    public async Task ShouldSupportString(string url)
    {
        ...
        await client.Create("string", new StringRecord { Name = "none", Value = null });
        await client.Create(
            "string",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportLong(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create("number", new LongRecord { Name = "none", Value = null });
        await client.Create(
            "number",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShoulSupportDecimal(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create("decimal", new DecimalRecord { Name = "none", Value = null });
        await client.Create(
            "decimal",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportFloat(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create("decimal", new FloatRecord { Name = "none", Value = null });
        await client.Create(
            "decimal",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportDouble(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create("decimal", new DoubleRecord { Name = "none", Value = null });
        await client.Create(
            "decimal",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportDuration(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create(
            "duration",
            new DurationRecord { Name = "none", Value = Duration.Zero }
        );
        await client.Create(
            "duration",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportTimeSpan(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create(
            "duration",
            new TimeSpanRecord { Name = "none", Value = new TimeSpan() }
        );
        await client.Create(
            "duration",
        ...
        var complexDuration = new TimeSpan();
        complexDuration.Add(TimeSpan.FromHours(1));
        complexDuration.Add(TimeSpan.FromMinutes(30));
        complexDuration.Add(TimeSpan.FromSeconds(21));
        complexDuration.Add(TimeSpan.FromMilliseconds(350));
        await client.Create(
            "duration",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportDateTime(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create("datetime", new DateTimeRecord { Name = "none", Value = null });
        await client.Create(
            "datetime",
            new DateTimeRecord
            {
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportVector2(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
        ...
        await client.Create("vector", new Vector2Record { Name = "none", Value = null });
        await client.Create(
            "vector",
    ...
    [InlineData("http://localhost:8000")]
    [InlineData("ws://localhost:8000/rpc")]
    public async Task ShouldSupportThing(string url)
    {
        await using var surrealDbClientGenerator = new SurrealDbClientGenerator();
        var dbInfo = surrealDbClientGenerator.GenerateDatabaseInfo();
